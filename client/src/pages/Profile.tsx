...
export default function Profile() {
  ...
  return <main className="profile-shell"><div className="profile-noise" /><div className="profile-wrap">
    <header className="profile-header"><Link href="/" className="back-link"><ArrowLeft size={16} /> voltar ao jogo</Link><div className="profile-brand">nexo<span>•</span> / perfil</div><div className="appearance-header-actions"><AppearanceSwitcher /><button className="profile-settings" aria-label="Editar perfil" onClick={openSettings}><Settings2 size={17} /></button></div></header>
