...
export default function Friends() {
  ...
  return <main className="friends-shell"><div className="friends-wrap">
    <header className="friends-header"><Link href="/" className="back-link"><ArrowLeft size={16} /> voltar ao jogo</Link><div className="friends-brand">nexo<span>•</span> social</div><Link href="/perfil" className="friends-avatar">{user?.name?.slice(0, 2).toUpperCase() ?? "AM"}</Link></header>
